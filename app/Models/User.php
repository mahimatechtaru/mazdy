...
use App\Models\Hospital\HospitalKycData;
class User extends Authenticatable
{
    ...
    public function kyc()
    {
        return $this->hasOne(HospitalKycData::class,'vendor_id');
    }
    ...
    {
        return $this->hasOne(HospitalWallet::class,'vendor_id');
    }
    ...
    public function familyProfiles() {
        return $this->hasMany(FamilyProfile::class,"user_id");
    }
