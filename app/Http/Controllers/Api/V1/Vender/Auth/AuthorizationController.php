...
namespace App\Http\Controllers\Api\V1\Vender\Auth;
...
class AuthorizationController extends Controller
{
    ...
    public function verifyEmailCode(Request $request)
    {
     ...
     public function getKycInputFields() {
        ...
        if(!$user_kyc) return ApiResponse::success(['success' => ['Vendor KYC section is under maintenance']], $data);
        ...
        return ApiResponse::success(['success' => [__('Vendor KYC input fields fetch successfully')]], $data);
    }
    ...
    public function kycSubmit(Request $request) {
        ...
        DB::beginTransaction();
        try{
            DB::table('hospital_kyc_data')->updateOrInsert(["vendor_id" => $user->id],$create);
            $user->update([
