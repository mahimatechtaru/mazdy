...
@section('content')
                        ...
                        <div class="user-action-btn-area">
                            ...
                            <div class="user-action-btn">
                                @include('admin.components.link.custom', [
                                    ...
                                    'text' => ucfirst($users->vendor->vendor_type) ?? '',
                                    'permission' => '#',
                                ])
                            </div>
    ...
    <div class="custom-card mt-15">
        ...
        <div class="card-body">
            <form class="card-form" method="POST" action="{{ setRoute('admin.vendors.details.update', $users->username) }}">
                @csrf
        ...
        <div id="wallet-balance-update-modal" class="mfp-hide large">
            <div class="modal-data">
                ...
                <div class="modal-form-data">
                    <form class="modal-form" method="POST" action="{{ setRoute('admin.hospitals.wallet.balance.update', $users->username) }}"
