        ...
        $(".edit-modal-button").click(function() {
            ...
            $.each(languages, function(index, item) {
                ...
                editModal.find("input[name=" + item.code + "_title_edit]").val(oldData.language[item.code]
                    ?.title);
                editModal.find("input[name=" + item.code + "_details_edit]").val(oldData.language[item.code]
                    ?.details);
                editModal.find("input[name=" + item.code + "_description_edit]").val(oldData.language[item
                    .code]?.description);
            });
