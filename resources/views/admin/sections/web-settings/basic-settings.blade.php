...
@section('content')
    <div class="custom-card">
        ...
        <div class="custom-card">
            ...
            <div class="card-body">
                <form class="card-form" method="POST" action="{{ setRoute('admin.web.settings.basic.settings.update.hospital') }}">
                    @csrf
                    @method("PUT")
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 form-group">
                            <label>{{ __("Site Base Color") }}*</label>
                            <div class="picker">
                                <input type="color" value="{{ old('hospital_base_color',$basic_settings->hospital_base_color) }}" class="color color-picker">
                                <input type="text" autocomplete="off" spellcheck="false" class="color-input" value="{{ old('hospital_base_color',$basic_settings->hospital_base_color) }}" name="hospital_base_color">
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 form-group">
                            <label>{{ __("Site Secondary Color") }}*</label>
                            <div class="picker">
                                <input type="color" value="{{ old('hospital_secondary_color',$basic_settings->hospital_secondary_color) }}" class="color color-picker">
                                <input type="text" autocomplete="off" spellcheck="false" class="color-input" value="{{ old('hospital_secondary_color',$basic_settings->hospital_secondary_color) }}" name="hospital_secondary_color">
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 form-group">
                            @include('admin.components.form.input',[
                    ...
                    <div class="row mb-10-none">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher', [
                                ...
                                'value' => old('hospital_secure_password', $basic_settings->hospital_secure_password),
                                'options' => [__('Activated') => 1, __('Deactivated') => 0],
                                'onload' => true,
                                'permission' => 'admin.web.settings.basic.settings.activation.update',
                            ])
