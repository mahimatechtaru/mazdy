        ...
        <div class="city-box">
            ...
            <div class="city-grid">
                <div class="city-item" data-city="Hyderabad">
                    <img src="{{ asset('frontend/images/element/hyderabad.76de1cc1.svg') }}" alt="Hyderabad">
                    <p>Hyderabad</p>
                </div>
                <div class="city-item" data-city="Kolkata">
                    <img src="{{ asset('frontend/images/element/kolkata.fb97ce82.svg') }}" alt="Kolkata">
                    <p>Kolkata</p>
                </div>
                <div class="city-item" data-city="Delhi">
                    <img src="{{ asset('frontend/images/element/delhi.6e21e427.svg') }}" alt="Delhi">
                    <p>Delhi</p>
                </div>
                <div class="city-item" data-city="Chennai">
                    <img src="{{ asset('frontend/images/element/chennai.2e7b9a5b.svg') }}" alt="Chennai">
                    <p>Chennai</p>
                </div>
                <div class="city-item" data-city="Bangalore">
                    <img src="{{ asset('frontend/images/element/beng.9c2db9f4.svg') }}" alt="Bangalore">
                    <p>Bangalore</p>
                </div>
                <div class="city-item" data-city="Mumbai">
                    <img src="{{ asset('frontend/images/element/mumbai.a4109533.svg') }}" alt="Mumbai">
                    <p>Mumbai</p>
                </div>
            </div>
        </div>
