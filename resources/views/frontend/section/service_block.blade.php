@php
    ...
    $leftItems = $features->slice(0, 5);
    $rightItems = $features->slice(5, 5);
            ...
            <div class="side left">
                @foreach ($leftItems as $item)
                    @php
                        ...
                        $step_key++;
                    @endphp
                    <a href="{{ url('getservice-form/' . $item->id) }}" style="text-decoration: none; color: inherit;">
                        <div class="info-box box-{{ $leftIndex }}">
                            ...
                            <div class="text">
                                ...
                                <p>{{ substr($item->description ?? ($item->description ?? ''), 0, 50) }}
